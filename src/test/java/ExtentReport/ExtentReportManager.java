...
public class ExtentReportManager {
    ...
    final static String homeDir = System.getProperty("user.dir");

    final static String reportDir = homeDir + "/src/test/Reports/ExtentReport.html";
    ...
    public static ExtentReports extentSetup() {
        ...
        extentReports.setSystemInfo("Url", ("https://go.lpi.co.za/"));
